        ...
        <div className="relative z-10 mx-auto px-4 pb-4 pt-10 sm:px-6 md:max-w-2xl md:px-4 lg:min-h-full lg:flex-auto lg:border-x lg:border-slate-200 lg:py-12 lg:px-8 xl:px-12">
          ...
          <section className="mt-10 lg:mt-12 mb-10">
            ...
            >
              ...
              <a target='_blank' rel="noreferrer"  href="https://www.subscribebyemail.com/feeds.blubrry.com/feeds/1473047.xml" title="Subscribe by Email"><Image src="https://assets.blubrry.com/sbe/EmailBadgeLarge.png" alt="Subscribe by Email" /></a>
            </ul>
          </section>
